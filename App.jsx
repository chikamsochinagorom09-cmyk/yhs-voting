    ...
    try {
      const res = await fetch("https://api.groq.com/openai/v1/chat/completions", {
        ...
        headers: {
          ...
          "Authorization": "Bearer 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"
        },
        body: JSON.stringify({ model: "llama-3.3-70b-versatile", max_tokens: 1000, messages: [{ role: "system", content: SYSTEM_PROMPT }, ...newMsgs] })
      });
      const data = await res.json();
      if (data.error) {
        setMsgs([...newMsgs, { role: "assistant", content: "Error: " + data.error.message }]);
      } else {
